...
var countOccurrences = function (code, target) {
    var result = [];
    var rowIndex = 0;
    var colIndex = 0;
    var i = 0; // generic variable for iterating through the code string
    while (i < code.length) {
        ...
        if (currentChar === target[0] &&
            ...
            while (k < target.length) {
                var checkingChar = code[i + k];
                var nextChar = code[i + k + 1];
